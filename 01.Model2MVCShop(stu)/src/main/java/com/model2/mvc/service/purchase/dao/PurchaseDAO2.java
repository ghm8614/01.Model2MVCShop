...
public class PurchaseDAO2 {
	...
	public void updateTranCode(PurchaseVO purchaseVO) throws Exception {
		...
		pstmt.setInt(2, purchaseVO.getTranCode().equals("2") ? purchaseVO.getPurchaseProd().getProdNo()
				: purchaseVO.getTranNo());

		System.out.println(purchaseVO.getTranCode().equals("2") ? purchaseVO.getPurchaseProd().getProdNo()
				: purchaseVO.getTranNo());
